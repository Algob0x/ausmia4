...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    //new logo
    private static final ResourceLocation logoPerso = new ResourceLocation("textures/gui/title/logo.png");
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 72 + 12, 98, 20, "Quitter le jeu"));
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(15, this.width / 2 - 100, p_73969_1_ + 35, EnumChatFormatting.YELLOW + "Rejoindre Ausmia"));
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        if (button.id == 15)
        {
        	this.mc.displayGuiScreen(new GuiConnecting(this, mc, "178.33.238.142", 25565)); //this number is port
        }
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        String s1 = "Copyright Arkacia TM";
    ...
    public void afficherLogo() {
    	this.mc.getTextureManager().bindTexture(logoPerso);
    	...
    	wR.pos((double)this.width / 2 - 60, (double)0, (double)this.zLevel).tex((double)0, (double)0).endVertex();
    	wR.pos((double)this.width / 2 - 60, (double)this.height/2, (double)this.zLevel).tex((double)0, (double)1).endVertex();
    	wR.pos((double)this.width / 2 + 60, (double)this.height/2, (double)this.zLevel).tex((double)1, (double)1).endVertex();
    	wR.pos((double)this.width / 2 + 60, (double)0, (double)this.zLevel).tex((double)1, (double)0).endVertex();
    	tess.draw();
    }
